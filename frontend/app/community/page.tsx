export default function Home() {
    return (
        <>
            ...
            <h2 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 p-8">コミュニティ</h2>
            ...
            <section className="text-gray-600 body-font">
                <h2 className="sm:text-2xl sm:text-1xl font-medium title-font text-gray-900 p-8">おすすめのコミュニティ一覧</h2>
                <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 px-16">
                    <div className="p-8 md:w-1/7 flex flex-col text-center items-center">
                        <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-10 h-10" viewBox="0 0 24 24">
