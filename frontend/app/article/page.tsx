...
export default function Home() {
    return (
        <>
            ...
            <h2 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 p-8">記事一覧</h2>

            <section className="text-gray-600 body-font">
                <h2 className="sm:text-2xl sm:text-1xl font-medium title-font text-gray-900 p-8">最新の記事一覧</h2>
