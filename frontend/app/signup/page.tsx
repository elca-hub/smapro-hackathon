              ...
              <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full mt-10 md:mt-0">
                  ...
                  <div className="relative mb-4">
                      ...
                      id="password"
                          ...
                          required
                          onChange={(event) => setPasswordonfirmation(event.target.value)}
                      />
                  </div>
                  <button className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" type="submit">サインアップ</button>
              </div>
          </div>
        </form>
    </section>
